...
export function GroundPlanePanelContent() {
  ...
  return (
    <PanelContainer>
      ...
      <AnimatableRow
        label='Solid'
        path='model.groundPlane.solid'
        value={groundPlane.solid}
        defaultValue={MODEL_DEFAULTS.groundPlane.solid}
        onReset={() => updatePlane({ solid: MODEL_DEFAULTS.groundPlane.solid })}
      >
      ...
      <AnimatableRow
        label='Color'
        path='model.groundPlane.color'
        value={groundPlane.color}
        defaultValue={MODEL_DEFAULTS.groundPlane.color}
        onReset={() => updatePlane({ color: MODEL_DEFAULTS.groundPlane.color })}
      >
      ...
      <AnimatableRow
        ...
        path='model.groundPlane.receiveShadows'
        value={groundPlane.receiveShadows}
        defaultValue={MODEL_DEFAULTS.groundPlane.receiveShadows}
        onReset={() => updatePlane({ receiveShadows: MODEL_DEFAULTS.groundPlane.receiveShadows })}
      >
